...
add_action('register_form', function() {
    ...
    <label><?php _e( 'School'); ?>
        ...
        <select name="school" class="input" id="school">
            ...
            <option value="Belding Elementary (Chicago Public Schools)">Belding Elementary (Chicago Public Schools)</option>
            ...
            <option value="Dwight D. Eisenhower (Palm Beach Schools)">Dwight D. Eisenhower (Palm Beach Schools)</option>
            ...
            <option value="Jackie Robinson Elementary (Chicago Public Schools)">Jackie Robinson Elementary (Chicago Public Schools)</option>
            ...
            <option value="King Elementary (Chicago Public Schools)">King Elementary (Chicago Public Schools)</option>
            ...
            <option value="Lillian Elementary (Alvarado ISD)">Lillian Elementary (Alvarado ISD)</option>
            ...
            <option value="Luna Elementary (Garland ISD)">Luna Elementary (Garland ISD)</option>
            ...
            <option value="Portgage Elementary (Chicago Public Schools)">Portgage Elementary (Chicago Public Schools)</option>
            ...
            <option value="Roan Elementary (Dalton Public Schools)">Roan Elementary (Dalton Public Schools)</option>
            ...
            <option value="Squires Elementary (Clark County School District)">Squires Elementary (Clark County School District)</option>
            ...
            <option value="Summer Elementary (Chicago Public Schools)">Summer Elementary (Chicago Public Schools)</option>
            ...
            <option value="Teague Elementary (Pasadena ISD)">Teague Elementary (Pasadena ISD)</option>
            ...
            <option value="Wildwood Elementary (Chicago Public Schools)">Wildwood Elementary (Chicago Public Schools)</option>
